...
class el_t
{
 private:  // these will change depending
  ...
  char gender; //add 2 more pieces of info here gender
  string major; //major

 public:

  el_t();  // to create a blank el_t object
  el_t(int, string, char, string); // to create an initialized el_t object - useful for the client   ** add more arguments to create the object
