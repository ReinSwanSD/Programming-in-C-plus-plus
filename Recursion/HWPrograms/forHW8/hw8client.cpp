...
{ 
  ...
  //this app will help show teachers how many students in computer science or computer info system are male or female
  ...
  cin >> selection;
    ...
    case 1:  // Add and indicate slot
      ...
      cin >> thename;
      cout << "What is the gender(m/f)? ";//      ** //  Here get two more pieces of info
      cin >> thegender; 
      cout << "What major (CS or CIS)? ";
      cin >> themajor;
      //  Create the element with all the info 
      theelement = el_t(thekey,thename,thegender,themajor);
